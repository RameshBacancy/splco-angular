...
export class SvgToPngComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //   var svgString2 = document.getElementById('svg-container').innerHTML;
    //   console.log('svgString', svgString2)
    //   svgString2Image(svgString2, 2 * width, 2 * height, 'png', save); // passes Blob and filesize String to the callback
